...
export default function Projects({ onOpenProjectModal }) {
  return (
    <section id="portfolio" className="section-muted relative">
      <div className="container mx-auto max-w-7xl px-6">
        {/* Fixed / Sticky Projects Section Header */}
        <div className="sticky top-[70px] z-50 bg-gray-50/95 backdrop-blur-md pt-4 pb-4 mb-4 border-b border-gray-200/40">
        ...
        {/* Stacked Case Study Cards Container (Positioned Below Fixed Header) */}
        <div className="space-y-16 md:space-y-24 pb-16">
          {projects.map((project, index) => {
            ...
            return (
              ...
              >
                <GooeyElementReveal mode="scroll" start="top 85%" end="top 25%" yFrom={35} blurAmount={12}>
                  <div className="relative rounded-[2.5rem] bg-white border border-gray-200/90 p-6 sm:p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-500 group overflow-hidden">
                    ...
                    <div className="grid gap-8 lg:grid-cols-12 items-center">
                      ...
                      <div className="lg:col-span-6 flex flex-col justify-between h-full">
                        <div>
                          ...
                          <GooeyTextReveal mode="scroll" start="top 85%" delay={0.1}>
                        ...
                        <div>
                          ...
                          >
                            VIEW CASE STUDY <i className="fas fa-arrow-up-right-from-square text-xs group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                          </button>
                        </div>
                      </div>
